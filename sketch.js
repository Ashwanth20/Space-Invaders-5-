...
function preload(){
  ...
  button4Img = loadImage("Images/nextLevel.png")
  ...
  bullet3Img = loadImage("Images/bullet3.png")

    //Loading The Enemy Image
  enemy1Img = loadImage("Images/enemyShip2.png");
  enemy2Img = loadImage("Images/enemyShip.png")
...
function setup() {
  ...
  button4 = createSprite(width/2, height/2 + 100, 30, 30)
  button4.addImage(button4Img);
  button4Img.scale = 2
  button4.visible = false;

  gameOver = createSprite(width/2, height/2, 180, 180)
  gameOver.addImage(gameOverImg);
  gameOverImg.scale = 4
  gameOver.visible = false;

  win = createSprite(width/2, height/2 - 120, 80, 80)
  win.addImage(winImg)
  win.scale = 2
  win.visible = false;
  ...
  spaceShip.scale = 0.8;
  spaceShip.setCollider("circle", 0, 0, 55);
...
function draw() {
  ...
  if(gameState === "serve"){
    ...
    //Making The "serve" State Go To "wait" State, When Easy, Medium, Hard Buttons Is Pressed
  ...
  if(gameState === "play1"){
    ...
    spaceShip.collide(edges[0]);
      ...
      enemy1.velocityX = 5;
      enemy1.lifetime = 250;
      enemy1.y = Math.round(random(100,500));
  ...
  spaceShip.collide(edges[0]);
    ...
    if(frameCount % 100 === 0){
    enemy2 = createSprite(width/2 - 600, height/2 - 600, 30, 30);
    ...
    enemy2.velocityY = 5;
    enemy2.lifetime = 250;
    enemy2.x = Math.round(random(100,400));
